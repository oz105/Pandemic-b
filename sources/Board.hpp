...
namespace pandemic {
    ...
    public:
        ...
        static const std::unordered_map<City, std::string> city_to_string; 

        static const std::unordered_map<Color,std::string> color_to_string ;
        ...
        friend std::ostream& operator<<(std::ostream& os, Board& b); // board should be const.
        ...
        static std::string get_city(City c);
    
        static std::string get_color(Color c);
